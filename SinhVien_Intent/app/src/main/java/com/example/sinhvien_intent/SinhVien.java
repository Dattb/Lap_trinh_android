...
public class SinhVien {
    ...
    public SinhVien(String hoTen, int maSV, int namSinh, String lop, Double diem, String chucvu) {
        HoTen = hoTen;
        MaSV = maSV;
        NamSinh = namSinh;
        Lop = lop;
    ...
    public SinhVien(String hoTen, int maSV, int namSinh, String lop, Double diem) {
        HoTen = hoTen;
        MaSV = maSV;
        NamSinh = namSinh;
        Lop = lop;
